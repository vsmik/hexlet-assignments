...
class AppTest {
    ...
    void testReversedSequence() {
        ...
        assertThat("fedcba").isEqualTo(reversedSequence.toString());
        assertThat('e').isEqualTo(reversedSequence.charAt(1));
        assertThat(6).isEqualTo(reversedSequence.length());
        assertThat("edc").isEqualTo(reversedSequence.subSequence(1, 4).toString());
    }
    // END
}
